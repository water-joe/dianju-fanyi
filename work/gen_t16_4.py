# -*- coding: utf-8 -*-
"""生成 2016 考研英语二 Text 4 的数据文件 site/data/2016-text4.js。

用法：  python work/gen_t16_4.py
...
from t16_4_a import A as A1
from t16_4_b import A as A2
from t16_4_c import A as A3
from t16_4_gloss import GLOSS
...
PASSAGE = dict(
    ...
    subtitle='美国年轻人的新成功路线图：代际分歧与更艰难的攀登',
    source=SOURCE,
