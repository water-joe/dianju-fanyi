# -*- coding: utf-8 -*-
"""生成 2017 考研英语二 Text 1 的数据文件 site/data/2017-text1.js。

用法：  python work/gen_t17_1.py

校验规则与 work/gen_t23_4.py 完全一致：
  · 每个 bold 子串必须真实存在于原句
...
from t17_1_a import A as A1
from t17_1_b import A as A2
from t17_1_c import A as A3
from t17_1_gloss import GLOSS
...
PASSAGE = dict(
    ...
    subtitle='Parkrun 的成功：奥运「遗产」失效处，草根体育正在赢',
    source=SOURCE,
